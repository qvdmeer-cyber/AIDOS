...
Assert-Reload ($text.IndexOf("Wait-AidosRepositoryHostReload",[StringComparison]::Ordinal) -ge 0 -and $text.IndexOf("fresh RUNNING heartbeat",[StringComparison]::Ordinal) -ge 0) 'Repository Handoff reload requires a fresh post-update host heartbeat'
