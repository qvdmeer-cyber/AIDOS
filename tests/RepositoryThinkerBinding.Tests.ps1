...
Assert-Binding ($bindingSource.Contains('for($attempt=0;$attempt-lt30;$attempt++)')) 'Repository Thinker allows bounded cold-start focus settling before failing closed'
