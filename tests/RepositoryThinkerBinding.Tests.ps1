...
Assert-Binding ($bindingSource.Contains('$focusCooldownMilliseconds=750') -and $bindingSource.Contains('Start-Sleep -Milliseconds $focusCooldownMilliseconds')) 'Repository Thinker settles foreground/UIA focus before touching the composer'
